...
void readParameter(PARAMS *p, int argc, char **argv)
{
 ...
 PTABLE_addParameter(&t, flagVerbose[0], flagVerbose[1], 0);

 PTABLE_read(&t, argc, argv);

 if(PTABLE_hasArgument(&t, flagVerbose[0])) p->flags |= 1;
...
int interpret(DS *stack, char *input)
{
 ...
 if((strcmp(buf, SM_OP_INS[0])==0))
 {
  if(!sscanf(input + 4, " %Lf", &v1)) return 1;
  DS_push(stack, v1);
 }
 else
 {
  if(stack->c < 1) return 2;
  v1 = DS_pop(stack);

  if((strcmp(buf, SM_OP_INS[12])==0))
  {
   DS_push(stack, -v1);
  }
  else if((strcmp(buf, SM_OP_INS[9])==0))
  {
   while(v1 > 2.0 * 3.14159265358979323846) v1 -= 2.0 * 3.14159265358979323846;
   while(v1 < 0.0) v1 += 2.0 * 3.14159265358979323846;
   DS_push(stack, (long double) sin((double) v1));
  }
  else if((strcmp(buf, SM_OP_INS[10])==0))
  {
   while(v1 > 2.0 * 3.14159265358979323846) v1 -= 2.0 * 3.14159265358979323846;
   while(v1 < 0.0) v1 += 2.0 * 3.14159265358979323846;
   DS_push(stack, (long double) cos((double) v1));
  }
  else if((strcmp(buf, SM_OP_INS[11])==0))
  {
   while(v1 > 2.0 * 3.14159265358979323846) v1 -= 2.0 * 3.14159265358979323846;
   while(v1 < 0.0) v1 += 2.0 * 3.14159265358979323846;
   DS_push(stack, (long double) tan((double) v1));
  }
  else if((strcmp(buf, SM_OP_INS[6])==0) || strcmp(buf,7)==0)
  {
   DS_push(stack, (long double) log10((double) v1));
  }
  else if((strcmp(buf, SM_OP_INS[8])==0))
  {
  ...
  else
  {
   ...
   if((strcmp(buf, SM_OP_INS[1])==0))
   {
    DS_push(stack, v2 + v1);
   }
   else if((strcmp(buf, SM_OP_INS[2])==0))
   {
    DS_push(stack, v2 - v1);
   }
   else if((strcmp(buf, SM_OP_INS[3])==0))
   {
    DS_push(stack, v2 * v1);
   }
   else if((strcmp(buf, SM_OP_INS[4])==0))
   {
    DS_push(stack, v2 / v1);
   }
   else if((strcmp(buf, SM_OP_INS[5])==0))
   {
